/**
 * RJ359604 Game-Specific Translator
 *
 * Target plugin:
 * - InfoWindow.js (MV)
 *
...
const CACHE_TYPE = 'plugin_rj359604_info_window';
const SCENE_MAP_START_HOOK_FLAG = '__CHEAT_RJ359604_SCENE_MAP_START_HOOKED__';
const WINDOW_REFRESH_HOOK_FLAG = '__CHEAT_RJ359604_INFO_WINDOW_REFRESH_HOOKED__';
...
export class RJ359604Translator extends BasePluginTranslator {
    getPluginName() {
        return 'InfoWindow';
    }

    getPluginLabel() {
        return 'RJ359604 InfoWindow';
    }
        ...
        return [
            {
                ...
                id: 'plugin_rj359604_info_window_0',
                value: text,
                cacheKey,
            },
        ];
