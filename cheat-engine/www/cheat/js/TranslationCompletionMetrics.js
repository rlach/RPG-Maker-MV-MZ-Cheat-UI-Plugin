...
export function computeLangPairCompletionByKeyLength({ translationCache, sourceLang, targetLang }) {
    ...
    const completionPercent = totalKeyLength > 0 ? (translatedKeyLength / totalKeyLength) * 100 : 0;
