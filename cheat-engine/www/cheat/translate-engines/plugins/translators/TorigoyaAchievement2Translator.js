...
export class TorigoyaAchievement2Translator extends BasePluginTranslator {
  ...
  appendEntriesFromPluginParameters(parameters, output) {
    ...
    const achievements = this.parseAchievementParameterArray(
      parameters.baseAchievementData,
    );
  ...
  enablePluginTranslation() {
    ...
    if (
      ...
      popupWindowClass.prototype.drawTitle = function () {
        ...
        this.drawTextEx(
          `\\c[${namespace.parameter.popupTitleColor}]${title}`,
          40,
          0,
        );
      };
    ...
    if (
      ...
      const originalAddOriginalCommands =
