...
export const TAG_CONFIGS = [
    ...
    {
        description: 'waitQuarter',
        type: TAG_TYPE.WITHOUT_PARAMETER,
        tagSymbol: '.',
        requiredConsistency: false,
    },
    {
        description: 'waitSecond',
        type: TAG_TYPE.WITHOUT_PARAMETER,
        tagSymbol: '|',
        requiredConsistency: false,
    },
    ...
    {
        description: 'cancelDisplayAll',
        type: TAG_TYPE.WITHOUT_PARAMETER,
        tagSymbol: '<',
        requiredConsistency: false,
    },
    {
        description: 'noWaitInput',
        type: TAG_TYPE.WITHOUT_PARAMETER,
        tagSymbol: '^',
        requiredConsistency: false,
    },
    ...
    {
        description: 'actorFace',
        type: TAG_TYPE.WITH_NUMERIC_PARAMETER,
        tagSymbol: 'AF',
        requiredConsistency: false,
    },
    {
        description: 'actorClass',
        type: TAG_TYPE.WITH_NUMERIC_PARAMETER,
        tagSymbol: 'AC',
        requiredConsistency: false,
    },
    {
        description: 'actorNickname',
        type: TAG_TYPE.WITH_NUMERIC_PARAMETER,
        tagSymbol: 'AN',
        requiredConsistency: false,
    },
    ...
    {
        description: 'partyFace',
        type: TAG_TYPE.WITH_NUMERIC_PARAMETER,
        tagSymbol: 'PF',
        requiredConsistency: false,
    },
    {
        description: 'partyClass',
        type: TAG_TYPE.WITH_NUMERIC_PARAMETER,
        tagSymbol: 'PC',
        requiredConsistency: false,
    },
    {
        description: 'partyNickname',
        type: TAG_TYPE.WITH_NUMERIC_PARAMETER,
        tagSymbol: 'PN',
        requiredConsistency: false,
    },
    ...
    {
        description: 'itemNameIcon',
        type: TAG_TYPE.WITH_NUMERIC_PARAMETER,
        tagSymbol: 'II',
        requiredConsistency: false,
    },
    {
        description: 'weaponNameIcon',
        type: TAG_TYPE.WITH_NUMERIC_PARAMETER,
        tagSymbol: 'IW',
        requiredConsistency: false,
    },
    {
        description: 'armorNameIcon',
        type: TAG_TYPE.WITH_NUMERIC_PARAMETER,
        tagSymbol: 'IA',
        requiredConsistency: false,
    },
    {
        description: 'skillNameIcon',
        type: TAG_TYPE.WITH_NUMERIC_PARAMETER,
        tagSymbol: 'IS',
        requiredConsistency: false,
    },
    {
        description: 'stateNameIcon',
        type: TAG_TYPE.WITH_NUMERIC_PARAMETER,
        tagSymbol: 'IT',
        requiredConsistency: false,
    },
